...
export const clusterLockSoloV1X10 = {
  cluster_definition: {
    name: 'test v1.10.0',
    creator: {
...
export const clusterLockV1X11 = {
  cluster_definition: {
    ...
    operators: [
      { address: '', enr: 'enr:-HW4QATmT-Scb72Oj55zUTgP_Y4uDkhqO9w3XuZcUT8ArokjCS51cfUTnbKtm15QtmrAVe6UqnqS63bt-l4bEe6DtX2AgmlkgnY0iXNlY3AyNTZrMaECluxfYvSncUr6LKPA3QY5frGPKyMwpj-CcO6gnhOh2Js', config_signature: '', enr_signature: '' },
      { address: '', enr: 'enr:-HW4QBHNTCZtx3eNM861l6u1-LFhg6Tc20KW6a-9SjE8Lya_MXzOiUpgsva1AjxOHawhqgSucBH0aSOM_DSyt-9mICeAgmlkgnY0iXNlY3AyNTZrMaEC9n1e2YMrtazLItw3vV8_YeDsDR-dJqLLN-DFHYenGYo', config_signature: '', enr_signature: '' },
      { address: '', enr: 'enr:-HW4QHH4fJXiToQGscl26jRUiZ9hPSWr-K6N_Yu5Up0uAwOfdHWRlj79lOubJT7Fu1cAy8sJFisxubOj8_9Hi4yswpWAgmlkgnY0iXNlY3AyNTZrMaECOb21lG1ncK1klFhJSvgQVdKorJd0sP5EpzvKv8iAlb8', config_signature: '', enr_signature: '' },
      { address: '', enr: 'enr:-HW4QLqAOz3cHegNJ_ras5K7vjlQQ62n5dAfUF-WPMdU0gdBYITKlCBST4XcFPu7xxej89-8xjGeDYkyBsEKgWYifWmAgmlkgnY0iXNlY3AyNTZrMaECZp64s75vJwlfDFAo1bun4JuWgBn3JCmzZtXPqpnW50o', config_signature: '', enr_signature: '' },
    ],
