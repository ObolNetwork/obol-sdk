...
export const CHAIN_CONFIGURATION = {
  [AVAILABLE_SPLITTER_CHAINS[0]]: {
    SPLITMAIN_ADDRESS: { address: '0x2ed6c4B5dA6378c7897AC67Ba9e43102Feb694EE', bytecode: MAINNET_SPLITMAIN_BYTECODE },
    MULTICALL_ADDRESS: { address: '0xeefba1e63905ef1d7acba5a8513c70307c1ce441', bytecode: MAINNET_MULTICALL_BYTECODE },
    OWR_FACTORY_ADDRESS: { address: '0x119acd7844cbdd5fc09b1c6a4408f490c8f7f522', bytecode: MAINNET_OWR_FACTORY_BYTECODE },
    RETROACTIVE_FUNDING_ADDRESS: { address: '0xDe5aE4De36c966747Ea7DF13BD9589642e2B1D0d',bytecode:"" },
  },
  [AVAILABLE_SPLITTER_CHAINS[1]]: {
    SPLITMAIN_ADDRESS: { address: '0xfC8a305728051367797DADE6Aa0344E0987f5286', bytecode: HOLESKY_SPLITMAIN_BYTECODE },
    MULTICALL_ADDRESS: { address: '0xcA11bde05977b3631167028862bE2a173976CA11', bytecode: HOLESKY_MULTICALL_BYTECODE },
    OWR_FACTORY_ADDRESS: { address: '0xc0961353fcc43a99e3041db07ac646720e116256', bytecode: HOLESKY_OWR_FACTORY_BYTECODE },
    RETROACTIVE_FUNDING_ADDRESS: { address: '0x43F641fA70e09f0326ac66b4Ef0C416EaEcBC6f5',bytecode:"" },
  },
};
